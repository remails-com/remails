INSERT INTO api_users (id, email, name, password_hash) -- user 1: admin of org 1 and org 2, password is unsecure123
...
INSERT INTO api_users (id, email, name, password_hash) -- user 2: admin of org 2, password is unsecure123
VALUES ('94a98d6f-1ec0-49d2-a951-92dc0ff3042a', 'test-api@user-2', 'Test API User 2', '$argon2id$v=19$m=16,t=2,p=1$VlZ0SUUzdXRBZVFldEZpbQ$rNhHR3o94Zw1B4YVqty6xQ');
INSERT INTO api_users_organizations (api_user_id, organization_id, role)
